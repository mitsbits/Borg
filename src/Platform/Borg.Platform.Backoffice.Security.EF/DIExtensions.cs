...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        private static string connectionString = "Data Source=.;Initial Catalog=Borg.Sescurity;User Id=sa;Password=P@ssw0rd;Pooling=False;Max Pool Size=200;MultipleActiveResultSets=True";

        public static IServiceCollection AddCmsUsers(this IServiceCollection services, ILoggerFactory loggerFactory,
            IHostingEnvironment environment)
        {
            services.AddScoped<ICmsUserManager, CmsUserManager>();
